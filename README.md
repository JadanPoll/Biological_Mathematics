...
I will try to deliver a mechanism that doesn't intuit on mathematics but very differently from humanns, in such a rich database like way that no human could possibly do. it's ability to ask all there is to be asked,
answer all there ways there are to answer something, 
fail all the ways there are to fail and not discard wrogness and messiness in Mathematics. The hard part in fact, is the effectivenss with which it can learn and apply this without cheating or memorizing per se.
...
## Reasoning about the lookup table objection arguments 
